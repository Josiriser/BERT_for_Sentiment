import os
import torch
from data_preprocess import convert_data_to_feature,makeDataset
...
if __name__ == "__main__":
    ...
    train_data_feature = convert_data_to_feature('train_data.csv','train')
    test_data_feature = convert_data_to_feature('test_data.csv','test')
